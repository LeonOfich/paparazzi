...
void file_logger_start(void)
{
  ...
  if (file_logger != NULL) {
    fprintf(
      ...
      "nu0_1,nu0_2,nu0_3,nu0_4,nu_est1,nu_est2,nu_est3,nu_est4,PSI0_1,PSI0_2,PSI0_3,PSI0_4,z_dot1,z_dot2,z_dot3,z_dot4,sigma1,sigma2,sigma3,sigma4,s1,s2,s3,s4,nx_des,ny_des,freq\n"
    );
  }
}
...
void file_logger_periodic(void)
{
  ...
  fprintf(file_logger, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%d,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n",
          counter,
          imu.gyro_unscaled.p,
          imu.gyro_unscaled.q,
          imu.gyro_unscaled.r,
